...
#define RT_CAN_MSG_INIT(id,ide,rtr,rsv,len,priv,data) \
     {(id), (ide), (rtr), (rsv),(len),(priv),(0),(0),(data)}		 
#define RT_CAN_MSG_STD_INIT(id) \
     RT_CAN_MSG_INIT(id,0,0,0,8,0,0)	
		 
void rt_can_thread_entry(void *parameter)
{
//    struct rt_can_msg msg = RT_CAN_MSG_STD_INIT(0x11);
//		msg.data[0] = 1;
//		msg.data[1] = 2;
//	  msg.data[2] = 3;
//	  msg.data[3] = 4;
