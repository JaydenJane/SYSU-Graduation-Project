...
\usepackage{amssymb}
\usepackage{bm}
\usepackage[top=1.91cm, bottom=1.91cm, left=1.91cm, right=1.91cm]{geometry}
...
\newgeometry{top=2.54cm, bottom=2.54cm, left=2cm, right=2cm}
\begin{document}
%
% paper title
...
\title{\huge{Fast adaptive control of snake robots for pole climbing}}
...
% in the abstract
\begin{abstract}\,
Snake-liked robots are a class of biomorphic hyperredundant robots consist of many chainconnected active joint modules. Autonomy of this kind of robots is a complex problem. This paper propses an adaptive control framework for snake robots, specially for pole climbing. Our framework can react to environment changes in real time. Experiemental results that with our framework our snake-liked robot can adapt to poles with different diameters.
\end{abstract}
